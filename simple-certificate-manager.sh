...
import_certificate() {
    ...
    # Import certificate
    if fmsadmin certificate import "$cert_file" --keyfile "$key_file" --keyfilepass "$FMS_PASSWORD" -y -u "$FMS_USERNAME" -p "$FMS_PASSWORD" >> "$FMS_LOG_PATH/fms-import.log" 2>&1; then
